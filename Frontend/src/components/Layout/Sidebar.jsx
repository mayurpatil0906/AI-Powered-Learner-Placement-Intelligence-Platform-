  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 px-5 py-6 border-b border-surface-700/50">
        ...
        {!collapsed && (
          <div className="overflow-hidden">
            <h1 className="text-lg font-bold gradient-text whitespace-nowrap">LearnAI</h1>
            <p className="text-[10px] text-surface-400 whitespace-nowrap">Placement Intelligence</p>
          </div>
        )}
      </div>
      ...
      {!collapsed && user?.role && (
        <div className="px-5 py-3 border-b border-surface-700/30">
          <span className={`text-xs font-semibold px-2 py-1 rounded-full ${
            ...
            user.role === 'LEARNER' ? 'bg-blue-500/20 text-blue-300' :
      ...
      <div className="p-3 border-t border-surface-700/50">
        <button
          onClick={onToggle}
          className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-surface-400 hover:text-surface-100 hover:bg-surface-800/60 transition-all"
        >
          <svg
